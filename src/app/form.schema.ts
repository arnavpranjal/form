...
export const formSchema = z.object({
  ...
  //   }),
  startDate: z.date({ required_error: "startdate cannot be empty" }),
  endDate: z.date({ required_error: "startdate cannot be empty" }),
  phaseStartDate: z.date({ required_error: "startdate cannot be empty" }),
  phaseEndDate: z.date({ required_error: "startdate cannot be empty" }),
  // endDate: z
  //   .string()
